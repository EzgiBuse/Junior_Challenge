...
var TransactionalTestContext = /** @class */ (function () {
    ...
    TransactionalTestContext.prototype.monkeyPatchQueryRunnerCreation = function (queryRunner) {
        this.originQueryRunnerFunction = typeorm_1.DataSource.prototype.createQueryRunner;
        typeorm_1.DataSource.prototype.createQueryRunner = function () { return queryRunner; };
    };
    TransactionalTestContext.prototype.restoreQueryRunnerCreation = function () {
        typeorm_1.DataSource.prototype.createQueryRunner = this.originQueryRunnerFunction;
    };
